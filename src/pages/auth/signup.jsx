        ...
        <section className="sign-up-section">
            <form onSubmit={handleSubmit} className="form form-auth">
                ...
                <div className="input-auth">
                    ...
                    <input onChange={(e)=>{handleFormDetails(e,"confirmPassword")}} className="input-field auth-field" required type={showPassword?"text":"password"} id="signup-confirm-password" placeholder="*******" />
                </div>
